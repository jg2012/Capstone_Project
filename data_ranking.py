...
# Function to request all matches played by a specific player
def request_matches(player_id, api_key):
...
player_id = "sr:competitor:407573"

# Request matches for the player
data = request_matches(player_id, api_key)
